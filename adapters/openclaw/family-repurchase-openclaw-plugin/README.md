# Family Repurchase Agent OpenClaw Plugin

This is the OpenClaw Plugin prototype for Family Repurchase Agent.
...
FAMILY_AGENT_PROJECT_ROOT=/path/to/family-repurchase-agent
```
